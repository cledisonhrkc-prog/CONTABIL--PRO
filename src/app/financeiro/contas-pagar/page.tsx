/**
 * Contas a Pagar — lista completa com filtros e baixa
 */
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">Títulos de fornecedores</p>
        </div>
        <Link href="/financeiro" className="text-sm text-blue-600 hover:underline">
          ← Voltar ao Dashboard
        </Link>
      </div>
